...
POLICIES: list[dict] = [
    ...
    dict(
        name="sym_et_B",
        corroborate=None,
        expect_bytes=9550253,
        role="ai_opponent",
        game="sym",
        seat="B",
        method="et",
        display=DISPLAY["et"],
        # Pool member ET_v4g800A. ET / early termination. The beatable one: the player takes 63% of the head-on lines off it at 1.4 m/s. It topples in half of them, which is what an early-termination arm does on contact and is not something to select away -- only OURS has to stay on its feet.
        source=CACHE / "ET_v4g800.pt",
        upstream="/home/ray/Go2/Project/unitree_rl_mjlab/archive/sym_anchors/ET_v4g800.pt",
        upstream_md5="1d5e937952b15cf7f7d8dc36b8fb056a",
        provenance="pulled from the 5080 into .cache/; md5 verified byte-identical",
        ckpt_seat="attacker",
        obs_dim=60,
        act_dim=12,
        native_half="A",
        action_path="increment_integrator",
        notes="ET_v4g800A, the A half; seated at B, pi-rotation baked in.",
    ),
    dict(
        name="sym_nom_B",
        corroborate=None,
    ...
    dict(
        ...
        method="cpo",
        display=DISPLAY["cpo"],
        # Pool member C_v3s59g2700B. CPO / constrained policy optimisation. Beatable at 63% of the head-on lines at 1.4 m/s; C_v2s41g3700B is steadier but the player only takes 38% off it, which is the wrong way round for a baseline.
        source=MJLAB / "logs/rsl_rl/game_sym_touchdown_go2_go2_wbc_cpo/2026-08-21_21-42-19_sym_c_v3_s59/game_2700.pt",
        upstream="/home/ray/Go2/Project/unitree_rl_mjlab/logs/rsl_rl/game_sym_touchdown_go2_go2_wbc_cpo/2026-08-21_21-42-19_sym_c_v3_s59/game_2700.pt",
        upstream_md5="bc6c8cbfe220abe77fe319bc381ff82b",
        provenance="local original; md5 recorded here",
        ckpt_seat="defender",
        obs_dim=60,
        act_dim=12,
        native_half="B",
        action_path="increment_integrator",
        notes="C_v3s59g2700B, the B half; seated at B, its native half, no rotation.",
    ),
    dict(
        name="sym_lag_B",
        corroborate=None,
